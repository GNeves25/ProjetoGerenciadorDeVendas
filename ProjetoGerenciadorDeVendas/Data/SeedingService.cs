...
using ProjetoGerenciadorDeVendas.Models.Enums;

namespace ProjetoGerenciadorDeVendas.Data
{
    public class SeedingService
    {
        private ProjetoGerenciadorDeVendasContext _context;

        public SeedingService(ProjetoGerenciadorDeVendasContext context)
        {
            _context = context;
        }
